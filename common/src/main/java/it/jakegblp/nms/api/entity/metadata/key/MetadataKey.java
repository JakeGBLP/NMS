...
public class MetadataKey<E extends Entity, T> {
    ...
    public MetadataKey(Class<E> entityClass, int index, @NotNull T defaultValue) {
        this(entityClass, index, defaultValue, (Class<T>) defaultValue.getClass(), new EntitySerializerInfo<>((Class<T>) defaultValue.getClass(), EntitySerializerInfo.Type.NORMAL));
    }
}
