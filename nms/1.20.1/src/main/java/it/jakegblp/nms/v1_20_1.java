...
import static org.bukkit.craftbukkit.v1_20_R1.CraftRegistry.getMinecraftRegistry;
import static org.bukkit.craftbukkit.v1_20_R1.util.CraftNamespacedKey.toMinecraft;

public final class v1_20_1 extends NMSAdapter<
        Nameable,
        Entity,
        LivingEntity,
        Player,
    ...
    public EntityType<?> asNMSEntityType(org.bukkit.entity.EntityType entityType) {
        return getMinecraftRegistry(Registries.ENTITY_TYPE).getOptional(toMinecraft(entityType.getKey())).orElseThrow();
    }
