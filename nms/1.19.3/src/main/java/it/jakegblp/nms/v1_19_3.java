...
import static org.bukkit.craftbukkit.v1_19_R2.util.CraftNamespacedKey.toMinecraft;

public final class v1_19_3 extends NMSAdapter<
        Nameable,
        Entity,
        LivingEntity,
        Player,
    ...
    public EntityType<?> asNMSEntityType(org.bukkit.entity.EntityType entityType) {
        return BuiltInRegistries.ENTITY_TYPE.get(toMinecraft(entityType.getKey()));
    }
