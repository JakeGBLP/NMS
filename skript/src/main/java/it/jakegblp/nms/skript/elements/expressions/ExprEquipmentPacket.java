...
public class ExprEquipmentPacket extends SectionExpression<SetEquipmentPacket> {
    ...
    static {
        ...
        Skript.registerExpression(ExprEquipmentPacket.class, SetEquipmentPacket.class, ExpressionType.COMBINED,
