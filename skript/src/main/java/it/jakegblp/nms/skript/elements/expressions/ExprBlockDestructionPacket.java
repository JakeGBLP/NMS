...
public class ExprBlockDestructionPacket extends SectionExpression<BlockDestructionPacket> {
    ...
    static {
        VALIDATOR = EntryValidator.builder()
                ...
                .build();
        Skript.registerExpression(ExprBlockDestructionPacket.class, BlockDestructionPacket.class, ExpressionType.COMBINED,
